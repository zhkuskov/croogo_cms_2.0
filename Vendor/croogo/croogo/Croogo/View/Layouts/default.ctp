...
<head>
	...
	<?php
        ...
        echo $this->Regions->blocks('trackinghead');
	?>
</head>
<body>
	<div id="wrapper">
		...
		<div id="main" class="container_16">
			...
			<?php
                echo $this->Regions->blocks('header');
		...
		<div id="footer">
			<div class="container_16">
				<div class="grid_8 left">
					Powered by <a href="mailto:anton.kost@sonymusicexternal.com">Toni T</a> and <a href="mailto:bjoern.wahle@sonymusicexternal.com">Bjoerni B</a>.
				</div>
				<div class="clear"></div>
			</div>
		</div>
	...
	<?php
        ...
        echo $this->Regions->blocks('trackingbody');
	?>
	</body>
</html>